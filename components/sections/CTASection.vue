    ...
    <div class="max-w-4xl mx-auto text-center py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
      ...
      <div class="flex flex-col  justify-center space-y-5 text-center">
           <h2 class="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl font-[oswald-medium]">
            ...
            <p class="text-white font-spmono tracking-normal   text-center md:text-lgtext-[14px]  leading-4 ">
        ...
        <div class="text-2xl grid grid-flow-col space-x-4 justify-center">
          ...
          <a class="hover:text-yellow" target="_black" href="https://www.instagram.com/abductionsquad/"><font-awesome-icon :icon="['fab','instagram']"  /> </a>
        </div>
      </div>
    </div>
  </section>
