<template>
  <main class="w-full">
    ...
    <section
      class="w-full  smm:h-screen sm:min-h-[56vw] bg-cover bg-center px-3 antialiased lg:px-6 bg-no-repeat"
    >
      <div class="mx-auto max-w-7xl">
        <div class="container py-32 mx-auto text-center sm:px-4">
          ...
          >
            ...
            <span class="relative inline-block mt-3 text-orange-300"
              >whitelist.</span
            >
          </h1>
          <div
          ...
          >
            Enter your Ethereum address or ENS name to confirm that you're on
            our whitelist for the launch!
          </div>
          <div class="relative flex items-center max-w-xl mx-auto mt-12 overflow-hidden text-center rounded-full">
            <input
              type="text"
              placeholder="0x1...123 or ENS"
              v-model="address"
              @input="ensListener"
              class="w-full h-12 px-6 py-2 font-medium focus:outline-none text-gray-600"
            />
